    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all"
        />
        {searchQuery && (
          <button
          ...
          {filteredStories.map((story) => {
            ...
            return (
              <div
                ...
                className="p-4 sm:p-5 hover:bg-amber-50/40 dark:hover:bg-slate-700/40 transition-colors cursor-pointer flex gap-4 items-start group"
              >
                {/* Cover Thumbnail */}
                <img
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="font-bold text-base sm:text-lg text-gray-900 dark:text-slate-100 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                      {story.title}
                    </h3>
                  </div>
