      ...
      <div className="max-w-4xl mx-auto px-2.5 sm:px-6 h-14 flex items-center justify-between gap-1.5 sm:gap-2 flex-nowrap w-full">
        ...
        <div className="relative flex-1 min-w-0 max-w-[240px] sm:max-w-sm mx-1">
          <select
            ...
            className="appearance-none w-full pl-3.5 pr-8 py-2 rounded-xl border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 font-bold text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 text-left truncate cursor-pointer focus:outline-none focus:ring-1 focus:ring-zinc-400 shadow-sm"
          >
            {allChapters.map((c) => (
